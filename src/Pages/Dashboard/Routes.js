...
let Routes = [
    ...
    { label: "Add Sellers", path: "sellers/add", icon: FaHospitalUser, element: AddSellers, hide: true },
    { label: "Edit Sellers", path: "sellers/edit", icon: FaHospitalUser, element: AddSellers, hide: true },
    ...
    { label: "Add Buyers", path: "customers/add", icon: FaHospitalUser, element: AddBuyerForm, hide: true },
    { label: "Edit Buyers", path: "customers/edit", icon: FaHospitalUser, element: AddBuyerForm, hide: true },
