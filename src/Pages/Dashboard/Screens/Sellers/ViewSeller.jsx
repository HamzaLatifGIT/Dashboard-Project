...
import { GetProductsAPI, PurchaseProductAPI } from 'API/Product'
...
const AddSellerForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let res = await PurchaseProductAPI(formData)
        if (res.error != null) {
    ...
    const gettingData = async () => {
        setLoading(true)
        let res = await GetSpecifucUserAPI("seller", ID)
        if (res.error != null) {
            toast.error(res.error)
        } else {
        ...
        <>
            <PageWrapper loading={loading}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography customeType="heading"> Purchased Products </Typography>
                    {/* <Button variant='contained' onClick={() => Navigate("add")}> Buy Product </Button> */}
                    <CustomModal name="Buy Product">
                        <Typography customeType="heading" textAlign={"center"}> Purchase Product </Typography>
